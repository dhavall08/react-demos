...
class RecordList extends Component {
  ...
  pagesRender = (totalPages) => {

    return <div className="pagination">
      {Array(totalPages).fill().map((page, i) => {
        ...
        return <button
          ...
          onClick={(e) => {
            ...
            this.paginationClickHandler(e, i + 1);
      ...
      <div className='recordList'>
        {
          (loading || loading === null)
            && !users.data
            ? <p className='message'>
              Please wait while we are getting user details...</p>
            : (error
              ? <p className='message'>Something went wrong! <br />
                Please try after sometime.</p> :
              <div>
                <div className='div-table'>
                  <div className='div-row heading-row'>
                    <div className="div-col heading-col">
                          ...
                          <div className="div-col">
                            ...
                            <Link
                              ...
                              onClick={(e) => {
                                ...
                                this.deleteRecordClickHandler(e, user.id);

                              }
                              }
                              className='actions'>Delete</Link>
                          </div>
                        </div>
